...
try:
    while True:
        ...
        #We believe that this is where the error is, The code does not properly add the cross vector and correction vector.
        ...
        #Line above is where the robot should be working
